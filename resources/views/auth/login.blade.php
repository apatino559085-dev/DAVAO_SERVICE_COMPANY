...
<head>
    ...
    <title>Sign In — Davao Central Services Company Hiring Management System</title>
    ...
    <style>
        ...
        *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .status-msg {
            ...
            color: #059669; padding: 12px 16px; border-radius: 12px;
        ...
        .forgot-link { font-size: 13px; font-weight: 700; color: var(--primary-light); text-decoration: none; }
    ...
    <div class="login-card">
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="field">
                ...
                <input id="email" class="field-input" type="email" name="email" value="{{ old('email') }}" required autofocus placeholder="name@company.com">
